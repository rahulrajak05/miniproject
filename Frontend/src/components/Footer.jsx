...
const Footer = () => {
  ...
  "/quiz-home",
    ...
    // Do NOT include "/riseon-quiz" so it uses the centered layout like SignUp
...
<div className={`bg-[#f2f0ef] mt-6 ${hasSidebar ? "pl-0 md:pl-32 lg:pl-40 pr-5" : "px-5"} py-4`}>
  <div className="flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between text-xs text-black text-left">
