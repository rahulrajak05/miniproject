...
const DUMMY_QUESTIONS = [
  { text: 'What does IP stand for?', choices: ['Internet Provider', 'Internet Protocol', 'Internal Protocol', 'Internet Point'], correct: 'Internet Protocol' },
  { text: 'Which device is used to connect two different networks?', choices: ['Hub', 'Switch', 'Router', 'Repeater'], correct: 'Router' },
  { text: 'What does LAN stand for?', choices: ['Local Area Network', 'Large Area Network', 'Logical Access Network', 'Line Area Node'], correct: 'Local Area Network' },
  { text: 'Which protocol is used to send emails?', choices: ['HTTP', 'SMTP', 'FTP', 'SNMP'], correct: 'SMTP' },
  { text: 'What is the full form of URL?', choices: ['Uniform Resource Locator', 'Unified Resource Link', 'Universal Routing Layer', 'None of the above'], correct: 'Uniform Resource Locator' },
  { text: 'Which layer in the OSI model is responsible for routing?', choices: ['Data Link', 'Transport', 'Network', 'Physical'], correct: 'Network' },
  { text: 'Which device is used to regenerate weak signals?', choices: ['Switch', 'Router', 'Repeater', 'Bridge'], correct: 'Repeater' },
  { text: 'Which IP version uses 128-bit addressing?', choices: ['IPv1', 'IPv4', 'IPv6', 'IPX'], correct: 'IPv6' },
  { text: 'Which port number does HTTP use?', choices: ['25', '21', '80', '110'], correct: '80' },
  { text: 'What is the purpose of DNS?', choices: ['To manage MAC addresses', 'To convert IP to MAC', 'To translate domain names to IP addresses', 'To block traffic'], correct: 'To translate domain names to IP addresses' },
];
  ...
  return (
    <div className="min-h-screen p-6 bg-[#F5F5F5] flex flex-col md:flex-row gap-6">
      ...
      <div className="flex-1 bg-white p-6 rounded shadow space-y-6">
        ...
        <h2 className="text-2xl font-bold">Network - Beginner Quiz</h2>
