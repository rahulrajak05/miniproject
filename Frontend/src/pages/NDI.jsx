...
const DUMMY_QUESTIONS = [
  {
    ...
    choices: ['Remote Entry Syntax Transfer', 'Representational State Transfer', 'Remote Server Transfer', 'Request Server Token'],
    correct: 'Representational State Transfer',
  },
  {
    text: 'Which status code indicates a successful GET request?',
    choices: ['200', '201', '400', '500'],
    correct: '200',
  },
  {
    text: 'How do you access query parameters in Express?',
    choices: ['req.params', 'req.query', 'req.body', 'req.get'],
    correct: 'req.query',
  },
  {
    text: 'What is middleware in Express?',
    choices: ['A database', 'A helper function for HTML', 'Function that handles request and response', 'Route parameter'],
    correct: 'Function that handles request and response',
  },
  {
    text: 'Which middleware parses incoming JSON request bodies?',
    choices: ['express.static()', 'express.json()', 'express.router()', 'express.config()'],
    correct: 'express.json()',
  },
  {
    text: 'Which tool is used to test APIs manually?',
    choices: ['Webpack', 'Postman', 'Nodemon', 'NPM'],
    correct: 'Postman',
  },
  {
    text: 'What does `res.status(404).send("Not Found")` do?',
    choices: ['Redirects to error page', 'Sends a 404 response with message', 'Crashes server', 'Logs 404 error'],
    correct: 'Sends a 404 response with message',
  },
  {
    text: 'Which method updates an existing resource?',
    choices: ['GET', 'POST', 'PUT', 'HEAD'],
    correct: 'PUT',
  },
  {
    text: 'How are URL parameters accessed in Express?',
    choices: ['req.params', 'req.query', 'req.headers', 'req.meta'],
    correct: 'req.params',
  },
  {
    text: 'Which middleware serves static files?',
    choices: ['express.static()', 'express.json()', 'express.router()', 'express.files()'],
