...
const DUMMY_QUESTIONS = [
  ...
  },
  {
    ...
    choices: ['List', 'Set', 'Map', 'Collection'],
    correct: 'Map',
  },
  {
    text: 'Which keyword is used to inherit a class in Java?',
    choices: ['implement', 'extends', 'inherits', 'super'],
    correct: 'extends',
  },
  {
    text: 'Which interface does ArrayList implement?',
    choices: ['Set', 'Map', 'List', 'Queue'],
    correct: 'List',
  },
  {
  ...
  },
  {
    ...
    choices: ['Object', 'Class', 'ClassLoader', 'Abstract'],
    correct: 'Object',
  },
  {
    text: 'Which of the following is not a valid access modifier?',
    choices: ['public', 'private', 'void', 'protected'],
    correct: 'void',
  },
  {
  ...
  return (
    <div className="min-h-screen p-6 bg-[#F5F5F5] flex flex-col md:flex-row gap-6">
      <div className="flex-1 bg-white p-6 rounded shadow space-y-6">
        ...
        <h2 className="text-2xl font-bold">Java - Intermediate Quiz</h2>
