...
const DUMMY_QUESTIONS = [
  { text: 'What does DBMS stand for?', choices: ['Data Base Management System', 'Data Backup Management System', 'Data Banking Management System', 'Database Macro System'], correct: 'Data Base Management System' },
  { text: 'Which of the following is a DBMS?', choices: ['Windows', 'Oracle', 'Python', 'Linux'], correct: 'Oracle' },
  { text: 'Which language is used to retrieve data from a database?', choices: ['HTML', 'SQL', 'XML', 'C++'], correct: 'SQL' },
  { text: 'Which SQL keyword is used to fetch data?', choices: ['INSERT', 'SELECT', 'UPDATE', 'DELETE'], correct: 'SELECT' },
  { text: 'Which of the following is a type of database key?', choices: ['Class Key', 'Table Key', 'Primary Key', 'Object Key'], correct: 'Primary Key' },
  { text: 'A table in a database is also called a:', choices: ['Attribute', 'Field', 'Relation', 'File'], correct: 'Relation' },
  { text: 'Which SQL clause is used to filter records?', choices: ['FROM', 'WHERE', 'GROUP BY', 'ORDER BY'], correct: 'WHERE' },
  { text: 'What is the extension of a typical SQL file?', choices: ['.txt', '.doc', '.sql', '.exe'], correct: '.sql' },
  { text: 'Which command is used to remove a table from the database?', choices: ['REMOVE', 'DELETE', 'DROP', 'ERASE'], correct: 'DROP' },
  { text: 'Which one is an example of RDBMS?', choices: ['MS Excel', 'Oracle', 'Java', 'Windows'], correct: 'Oracle' },
];
  ...
  return (
    <div className="min-h-screen p-6 bg-[#F5F5F5] flex flex-col md:flex-row gap-6">
      ...
      <div className="flex-1 bg-white p-6 rounded shadow space-y-6">
        ...
        <h2 className="text-2xl font-bold">DBMS - Beginner Quiz</h2>
