...
const DUMMY_QUESTIONS = [
  {
    text: 'Which of the following techniques is used in Deep Reinforcement Learning?',
    choices: ['Policy Gradient', 'Bagging', 'SVM', 'Clustering'],
    correct: 'Policy Gradient',
  },
  {
    text: 'Which neural network is best suited for sequence prediction?',
    choices: ['CNN', 'RNN', 'GAN', 'DBN'],
    correct: 'RNN',
  },
  {
    text: 'Which algorithm is used for backpropagation in neural networks?',
    choices: ['Gradient Descent', 'K-means', 'Apriori', 'PageRank'],
    correct: 'Gradient Descent',
  },
  {
    text: 'Which of these is a technique for reducing dimensionality?',
    choices: ['PCA', 'KNN', 'CNN', 'GAN'],
    correct: 'PCA',
  },
  {
    text: 'What is the vanishing gradient problem?',
    choices: ['Gradient goes to zero in deep layers', 'Loss is infinite', 'Model diverges', 'Weights get too large'],
    correct: 'Gradient goes to zero in deep layers',
  },
  {
    text: 'Which of the following is a generative model?',
    choices: ['CNN', 'GAN', 'SVM', 'KNN'],
    correct: 'GAN',
  },
  {
    text: 'Attention mechanisms are primarily used in:',
    choices: ['Transformers', 'CNNs', 'SVMs', 'Autoencoders'],
    correct: 'Transformers',
  },
  {
    text: 'Which model is commonly used in AI for translation tasks?',
    choices: ['Transformer', 'K-means', 'RNN', 'CNN'],
    correct: 'Transformer',
  },
  {
    text: 'Which of the following is not a type of learning in AI?',
    choices: ['Supervised', 'Unsupervised', 'Reinforcement', 'Correlated Learning'],
    correct: 'Correlated Learning',
  },
  {
    text: 'What is the role of the loss function in machine learning?',
    choices: ['To adjust dataset', 'To optimize weights during training', 'To visualize data', 'To shuffle the data'],
    correct: 'To optimize weights during training',
  },
];
