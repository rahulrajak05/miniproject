...
const DUMMY_QUESTIONS = [
  {
    ...
    choices: ['Desktop apps', 'Mobile apps', 'Server-side development', 'Database management'],
    correct: 'Server-side development',
  },
  {
    text: 'Which command initializes a Node.js project?',
    choices: ['node start', 'npm init', 'node install', 'npm create'],
    correct: 'npm init',
  },
  {
    text: 'What is Express.js?',
    choices: ['Database', 'Templating engine', 'Node.js framework', 'Package manager'],
    correct: 'Node.js framework',
  },
  {
    text: 'Which port does a Node.js app commonly run on?',
    choices: ['3000', '80', '443', '22'],
    correct: '3000',
  },
  {
  ...
  },
  {
    ...
    choices: ['http', 'fs', 'url', 'path'],
    correct: 'http',
  },
  {
    text: 'Which method ends a response in Node.js?',
    choices: ['res.end()', 'res.finish()', 'res.complete()', 'res.sendData()'],
    correct: 'res.end()',
  },
  {
    text: 'How do you include a module in Node.js?',
    choices: ['include()', 'require()', 'import()', 'use()'],
    correct: 'require()',
  },
  {
    text: 'Which file typically starts a Node.js project?',
    choices: ['start.js', 'init.js', 'server.js', 'index.html'],
    correct: 'server.js',
  },
  {
    text: 'Which tool helps manage Node.js packages?',
    choices: ['Babel', 'NPM', 'MongoDB', 'MySQL'],
    correct: 'NPM',
  },
];
