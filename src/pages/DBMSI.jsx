...
const DUMMY_QUESTIONS = [
  {
    ...
    choices: ['Foreign Key', 'Unique Key', 'Primary Key', 'Super Key'],
    correct: 'Primary Key',
  },
  {
    text: 'Which of the following ensures referential integrity?',
    choices: ['Primary Key', 'Foreign Key', 'Candidate Key', 'Composite Key'],
    correct: 'Foreign Key',
  },
  {
  ...
  {
    text: 'The process of organizing data to reduce redundancy is called:',
    choices: ['Querying', 'Normalization', 'Joining', 'Indexing'],
    correct: 'Normalization',
  },
  {
    text: 'What does DDL stand for?',
    choices: ['Data Definition Language', 'Data Derivation Language', 'Data Direction Language', 'Database Directive Language'],
    correct: 'Data Definition Language',
  },
  {
    text: 'Which command is used to modify an existing table structure?',
    choices: ['UPDATE', 'ALTER', 'MODIFY', 'CHANGE'],
    correct: 'ALTER',
  },
  {
    text: 'Which of the following is not part of DML?',
    choices: ['INSERT', 'UPDATE', 'SELECT', 'CREATE'],
    correct: 'CREATE',
  },
  {
  ...
  {
    text: 'A view is:',
    choices: ['A table', 'A virtual table', 'A schema', 'A stored procedure'],
    correct: 'A virtual table',
  },
  {
    text: 'Which clause is used with aggregate functions?',
