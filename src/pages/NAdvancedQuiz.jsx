...
const DUMMY_QUESTIONS = [
  {
    text: 'Which protocol does traceroute use on most systems?',
    choices: ['TCP', 'UDP', 'ICMP', 'ARP'],
    correct: 'ICMP',
  },
  {
    text: 'What is the MTU in networking?',
    choices: ['Maximum Transfer Unit', 'Minimum Time Unit', 'Maximum Transmission Unit', 'Medium Transfer Utility'],
    correct: 'Maximum Transmission Unit',
  },
  {
    text: 'What does CIDR stand for in IP addressing?',
    choices: ['Classless Inter-Domain Routing', 'Connectionless Internet Data Routing', 'Common Internet Data Rule', 'Custom IP Domain Rules'],
    correct: 'Classless Inter-Domain Routing',
  },
  {
    text: 'Which protocol is used by BGP for routing decisions?',
    choices: ['Distance Vector', 'Path Vector', 'Link State', 'Hybrid'],
    correct: 'Path Vector',
  },
  {
    text: 'How many hosts can be assigned in a /26 subnet?',
    choices: ['30', '62', '64', '126'],
    correct: '62',
  },
  {
    text: 'Which protocol operates at Layer 2 and helps prevent loops?',
    choices: ['RIP', 'STP', 'OSPF', 'ICMP'],
    correct: 'STP',
  },
  {
    text: 'In IPv6, what does the address ::1 represent?',
    choices: ['Default gateway', 'Loopback address', 'Broadcast address', 'Multicast address'],
    correct: 'Loopback address',
  },
  {
    text: 'What is the primary function of ICMP?',
    choices: ['Routing', 'Time synchronization', 'Error reporting and diagnostics', 'Email transfer'],
    correct: 'Error reporting and diagnostics',
  },
  {
    text: 'Which algorithm is used by OSPF to calculate the shortest path?',
    choices: ['Bellman-Ford', 'Dijkstra', 'Flooding', 'Round Robin'],
    correct: 'Dijkstra',
  },
  {
    text: 'What is the default administrative distance of EIGRP?',
    choices: ['110', '120', '90', '100'],
    correct: '90',
  },
];
